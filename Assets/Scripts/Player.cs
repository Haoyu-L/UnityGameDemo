...
public class Player : MonoBehaviour
{
    ...
    [Tooltip("Time in seconds needed for a dash")]
    ...
    [Tooltip("Time in seconds needed before another dash")]
    ...
    private void Movement()
    {
        ...
        if (movementVelocity.x != 0 || movementVelocity.z != 0)
        {
            ...
            modelTrans.rotation = Quaternion.Slerp(modelTrans.rotation, Quaternion.LookRotation(movementVelocity), .11F);
        }
        }
    }
